...
void main() {
  ...
  group('get Now Playing Movies', () {
    final tMovieList = MovieResponse.fromJson(json
            .decode(readJson('dummy_data/dummy_data_movie/now_playing.json')))
        .movieList;
    ...
    test('should return list of Movie Model when the response code is 200',
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/dummy_data_movie/now_playing.json'), 200));
      // act
  ...
  group('get Popular Movies', () {
    ...
    test('should return list of movies when response is success (200)',
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/movie/popular?$API_KEY')))
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/dummy_data_movie/popular.json'), 200));
      // act
  ...
  group('get Top Rated Movies', () {
    ...
    test('should return list of movies when response code is 200 ', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/movie/top_rated?$API_KEY')))
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/dummy_data_movie/top_rated.json'), 200));
      // act
  ...
  group('get movie detail', () {
    ...
    final tMovieDetail = MovieDetailResponse.fromJson(
        json.decode(readJson('dummy_data/dummy_data_movie/movie_detail.json')));

    test('should return movie detail when the response code is 200', () async {
      // arrange
      when(mockHttpClient.get(Uri.parse('$BASE_URL/movie/$tId?$API_KEY')))
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/dummy_data_movie/movie_detail.json'), 200));
      // act
  ...
  group('get movie recommendations', () {
    final tMovieList = MovieResponse.fromJson(json.decode(
            readJson('dummy_data/dummy_data_movie/movie_recommendations.json')))
        .movieList;
    const tId = 1;
    ...
    test('should return list of Movie Model when the response code is 200',
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson(
                  'dummy_data/dummy_data_movie/movie_recommendations.json'),
              200));
      // act
  ...
  group('search movies', () {
    final tSearchResult = MovieResponse.fromJson(json.decode(readJson(
            'dummy_data/dummy_data_movie/search_spiderman_movie.json')))
        .movieList;
